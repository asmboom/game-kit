...
public enum GameEventType {
		...
		CHANGE_STATUS_EFFECT, CHECK_STATUS_EFFECT, 
...
public class GameEvent : BaseEvent
{
	...
	public EventStep TypeToStep(GameEventType t)
	{
		...
		else if(GameEventType.CHECK_STATUS_EFFECT.Equals(t)) s = new CheckStatusEffectStep(t);
	...
	*/
	...
	public void EndEvent()
	{
		...
		if(this.interaction != null && this.interaction.gameObject.activeInHierarchy)
		{
