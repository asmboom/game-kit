...
public class BaseAnimator : MonoBehaviour
{
	...
	void Start ()
	{
		...
		else
		{
			...
			{
				if(this.HasAnimation(this.runAnimation))
				{
					this.anim[this.runAnimation].layer = -1;
				}
				if(this.HasAnimation(this.walkAnimation))
				{
					this.anim[this.walkAnimation].layer = -1;
				}
				if(this.HasAnimation(this.idleAnimation))
				{
					this.anim[this.idleAnimation].layer = -2;
				}
