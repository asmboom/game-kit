...
public class RaceData : BaseLangData
{
	// XML data
	private string filename = "races";
	
	private static string RACES = "races";
	...
	public override string GetIconPath() { return "Icons/Race/"; }
	...
	public void LoadData()
	{
		...
		{
			this.AddBaseData("Default Race", "", DataHolder.LanguageCount);
		}
	}
