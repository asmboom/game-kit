...
public class ArrayHelper
{
	...
	public static EaseType[] Add(EaseType n, EaseType[] list)
	{
		ArrayList tmp = new ArrayList();
		foreach(EaseType str in list) tmp.Add(str);
		tmp.Add(n);
		return tmp.ToArray(typeof(EaseType)) as EaseType[];
	}
	
	public static EaseType[] Remove(int index, EaseType[] list)
	{
		ArrayList tmp = new ArrayList();
		foreach(EaseType str in list) tmp.Add(str);
		tmp.RemoveAt(index);
