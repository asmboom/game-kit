...
public class ClassData : BaseLangData
{
	...
	public void LoadData()
	{
		...
		{
			this.AddClass("Default Class", "", DataHolder.LanguageCount, 
				DataHolder.EquipmentParts().GetDataCount(), DataHolder.WeaponCount, 
				DataHolder.ArmorCount, DataHolder.ElementCount);
		}
	}
