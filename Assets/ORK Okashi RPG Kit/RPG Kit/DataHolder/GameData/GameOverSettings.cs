	...
	*/
	public Hashtable GetData(Hashtable ht)
	{
		...
		if(this.showChoice)
		{
			...
			ht.Add("showretry", this.showRetry.ToString());
			if(this.showRetry)
			{
			...
			ht.Add("showexit", this.showExit.ToString());
			if(this.showExit)
			{
	...
	public void SetData(Hashtable ht)
	{
		if(ht.ContainsKey("dialogueposition"))
		{
			...
			if(ht.ContainsKey("showretry"))
			{
				this.showRetry = bool.Parse((string)ht["showretry"]);
			}
			if(ht.ContainsKey("showload"))
			{
				this.showLoad = bool.Parse((string)ht["showload"]);
			}
			if(ht.ContainsKey("showexit"))
			{
				this.showExit = bool.Parse((string)ht["showexit"]);
			}
		}
