...
public class BattleEnd
{
	...
	*/
	public Hashtable GetData(Hashtable ht)
	{
		...
		if(this.wholePartyExp) ht.Add("wholepartyexp", "true");
		if(this.deadExp) ht.Add("deadexp", "true");
	...
	public void SetData(Hashtable ht)
	{
		...
		if(ht.ContainsKey("wholepartyexp")) this.wholePartyExp = true;
		if(ht.ContainsKey("deadexp")) this.deadExp = true;
