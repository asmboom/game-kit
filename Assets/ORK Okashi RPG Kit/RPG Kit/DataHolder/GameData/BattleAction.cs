...
public class BattleAction
{
	...
	*/
	public void PerformAction()
	{
		...
		// don't perform if blocked
		if(this.user.IsStopMove() || 
			((this.IsAttack() || this.IsCounter()) && this.user.IsBlockAttack()) ||
			(this.IsDefend() && this.user.IsBlockDefend()) || 
			(this.IsEscape() && this.user.IsBlockEscape()) || 
			(this.IsItem() && this.user.IsBlockItems()) || 
			(this.IsSkill() && (this.user.IsBlockSkills() || this.user.IsSkillBlocked(this.useID))))
		{
	...
	public void AnimationFinished()
	{
		...
		if(DataHolder.BattleSystem().deathActionPerforming)
		{
			DataHolder.BattleSystem().DeathActionFinished();
		}
		else if(!DataHolder.BattleSystem().dynamicCombat)
		{
