...
public class BattleAnimationTabs
{
	...
	public static void ShowTab(int index, BattleAnimation battleAnimation, AnimationStep baseStep)
	{
		...
		else if(baseStep is CheckStatusEffectAStep) BattleAnimationTabs.CheckStatusEffectAStep(index, battleAnimation, (CheckStatusEffectAStep)baseStep);
		// last
	...
	// status steps
	public static void CheckStatusEffectAStep(int index, BattleAnimation battleAnimation, CheckStatusEffectAStep baseStep)
	{
		baseStep.fold = EditorGUILayout.Foldout(baseStep.fold, "Step "+index+": Check Status Effect");
		if(baseStep.fold)
		{
			BattleAnimationTabs.AnimationStep(index, battleAnimation, baseStep);
			baseStep.statusOrigin = (StatusOrigin)EditorGUILayout.EnumPopup("Check", baseStep.statusOrigin, GUILayout.Width(mWidth));
