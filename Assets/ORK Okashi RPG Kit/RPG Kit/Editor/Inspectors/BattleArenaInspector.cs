...
public class BattleArenaInspector : BaseInspector
{
	...
	public override void OnInspectorGUI()
	{
		...
		if(fold1)
		{
			...
			((BattleArena)target).doLooks = EditorGUILayout.Toggle("Look at enemies", ((BattleArena)target).doLooks);
		...
		if(fold2)
		{
			...
			if(((BattleArena)target).startFadeScreen)
			{
				...
				{
					((BattleArena)target).startFadeAStart = EditorGUILayout.FloatField("From", ((BattleArena)target).startFadeAStart);
					((BattleArena)target).startFadeAEnd = EditorGUILayout.FloatField("To", ((BattleArena)target).startFadeAEnd);
					EditorGUILayout.Separator();
				}
				...
				{
					((BattleArena)target).startFadeRStart = EditorGUILayout.FloatField("From", ((BattleArena)target).startFadeRStart);
					((BattleArena)target).startFadeREnd = EditorGUILayout.FloatField("To", ((BattleArena)target).startFadeREnd);
					EditorGUILayout.Separator();
				}
				...
				{
					((BattleArena)target).startFadeGStart = EditorGUILayout.FloatField("From", ((BattleArena)target).startFadeGStart);
					((BattleArena)target).startFadeGEnd = EditorGUILayout.FloatField("To", ((BattleArena)target).startFadeGEnd);
					EditorGUILayout.Separator();
				}
				...
				{
					((BattleArena)target).startFadeBStart = EditorGUILayout.FloatField("From", ((BattleArena)target).startFadeBStart);
					((BattleArena)target).startFadeBEnd = EditorGUILayout.FloatField("To", ((BattleArena)target).startFadeBEnd);
					EditorGUILayout.Separator();
				}
			}
		...
		if(fold3)
		{
			...
			if(((BattleArena)target).endFadeScreen)
			{
				...
				{
					((BattleArena)target).endFadeAStart = EditorGUILayout.FloatField("From", ((BattleArena)target).endFadeAStart);
					((BattleArena)target).endFadeAEnd = EditorGUILayout.FloatField("To", ((BattleArena)target).endFadeAEnd);
					EditorGUILayout.Separator();
				}
				...
				{
					((BattleArena)target).endFadeRStart = EditorGUILayout.FloatField("From", ((BattleArena)target).endFadeRStart);
					((BattleArena)target).endFadeREnd = EditorGUILayout.FloatField("To", ((BattleArena)target).endFadeREnd);
					EditorGUILayout.Separator();
				}
				...
				{
					((BattleArena)target).endFadeGStart = EditorGUILayout.FloatField("From", ((BattleArena)target).endFadeGStart);
					((BattleArena)target).endFadeGEnd = EditorGUILayout.FloatField("To", ((BattleArena)target).endFadeGEnd);
					EditorGUILayout.Separator();
				}
				...
				{
					((BattleArena)target).endFadeBStart = EditorGUILayout.FloatField("From", ((BattleArena)target).endFadeBStart);
					((BattleArena)target).endFadeBEnd = EditorGUILayout.FloatField("To", ((BattleArena)target).endFadeBEnd);
					EditorGUILayout.Separator();
				}
			}
