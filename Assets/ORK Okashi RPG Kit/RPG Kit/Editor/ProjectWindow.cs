...
public class ProjectWindow : EditorWindow
{
	...
	public void AddLanguage(int lang)
	{
		...
		DataHolder.Races().AddLanguage(lang);
		DataHolder.Sizes().AddLanguage(lang);
		DataHolder.EquipmentParts().AddLanguage(lang);
		DataHolder.Classes().AddLanguage(lang);
		DataHolder.Characters().AddLanguage(lang);
		...
		DataHolder.Difficulties().AddLanguage(lang);
	}
	...
	public void RemoveLanguage(int lang)
	{
		...
		DataHolder.Races().RemoveLanguage(lang);
		DataHolder.Sizes().RemoveLanguage(lang);
		DataHolder.EquipmentParts().RemoveLanguage(lang);
		DataHolder.Classes().RemoveLanguage(lang);
		DataHolder.Characters().RemoveLanguage(lang);
		...
		DataHolder.Difficulties().RemoveLanguage(lang);
	}
